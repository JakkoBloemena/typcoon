// Zoomed crop of just the .hal diorama stage, to judge floor-grid legibility for the
// cold-read call (AC5) — a tight crop makes faint low-alpha grid lines easier to see
// or confirms they are, in practice, too faint to read.
...
async function main() {
  ...
  await hal.screenshot({ path: 'company/assignments/085-screenshots-verify/085-tester-hal-crop.png' });
